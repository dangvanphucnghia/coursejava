    ...
    <section id="benefits" className="bg-white py-16 sm:py-20" aria-labelledby="benefits-title">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
          <div>
            <p className="text-sm font-bold uppercase text-cyan-700">Lợi ích</p>
            <h2
              id="benefits-title"
              className="mt-3 text-3xl font-extrabold text-slate-950 sm:text-4xl"
            >
              Ít nhiễu hơn, nhiều thực hành hơn, dễ duy trì hơn.
            </h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {learningBenefits.map((benefit, index) => {
              ...
              return (
                <article
                  key={benefit}
                  className="rounded-lg border border-slate-200 bg-slate-50 p-5 transition hover:-translate-y-1 hover:bg-white hover:shadow-lg hover:shadow-slate-200/70"
                >
                  <span className="grid h-11 w-11 place-items-center rounded-lg bg-slate-950 text-cyan-300 shadow-sm">
